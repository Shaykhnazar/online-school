...
@section('contentadmin')
    ...
    <div class="row">
        <div class="col-md-6">
            <h3><u>"<?php echo $cats[0]->categoryname; ?>"</u> kategoriyasidagi savollar</h3>
        </div>
        <div class="col-md-6 text-right">
            <a class="newcatBtn" href="/admin-quizz/create-question/{{ $cats[0]->id }}" class="">Yangi savol qo'shish</a>
        </div>
    </div>
        ...
        @foreach($quests as $q)
            <div class="questionItem">
                <div class="row questionhead nomargin">
                    ...
                    <div class="col-md-2 text-center"><a href="/admin-quizz/edit-question/{{ $q->id }}">Tahrirlash</a></div>
                    <div class="col-md-2 text-center">
                        <div class="deletequest" qid="{{ $q->id }}" catid="{{ $q->questionqategory }}" qname="{{ $q->question }}">O'chirish</div>
                    </div>
